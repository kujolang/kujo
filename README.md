...
[![Version](https://img.shields.io/badge/version-1.4.0-black)](https://github.com/kujolang/kujo/releases/tag/v1.4.0)
...
- Kujo `v1.4.0` is the current stable release, with prebuilt binaries and checksums published through GitHub Releases.
...
`kujo upgrade 1.4.0` (exact stable version), and `kujo upgrade --check --json`
