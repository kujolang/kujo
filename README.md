...
[![Version](https://img.shields.io/badge/version-1.3.1-black)](https://github.com/kujolang/kujo/releases/tag/v1.3.1)
...
- Kujo `v1.3.1` is the current stable release, with prebuilt binaries and checksums published through GitHub Releases.
...
- The source tree is currently at `1.3.1` in `Cargo.toml`; the latest published stable release tag is `v1.3.1`.
- Prebuilt Linux x64/arm64, macOS x64/arm64, and Windows x64 binaries are distributed with per-asset SHA-256 files and a consolidated `checksums.txt`.
...
`kujo upgrade 1.3.1` (exact stable version), and `kujo upgrade --check --json`
