...
- Keep POSIX private-spool metadata verification behind Unix compilation gates,
  restoring the required Windows x64 release build while preserving fail-closed
  unavailability on non-Unix hosts.
