...
| `io_private_spool_write_file_range` | preview | `io_private_spool_write_file_range(spool, "body.bin", 0, size, "base64-crlf")` |
...
| `list_dir_beneath` | preview | `page := list_dir_beneath(".", "records", "", ".json", 100, 100000)` |
...
| `gzip_compress` | preview | `compressed := gzip_compress(payload)` |
...
| `sha256_file_beneath` | preview | `digest := sha256_file_beneath("assets", "video.mp4", 4294967296)` |
