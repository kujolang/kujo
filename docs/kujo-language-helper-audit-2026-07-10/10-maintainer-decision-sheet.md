...
| HLP-007 | current builtin examples | Kujo docs | ☑ docs only — verified |
...
| HLP-011 | existing env APIs | Kujo docs | ☑ docs only — verified |
| HLP-012 | 3 consumers with same root/config semantics | tooling package | ☐ package instead ☐ defer |
| HLP-013 | ProcessResult docs/examples | Kujo docs | ☑ docs only — verified |
| HLP-014 | AI SDK + Dispatch policy convergence | official package | ☐ prototype ☐ defer |
| HLP-015 | current deterministic JSON contract | Kujo docs | ☑ docs only — verified |
...
The detailed verification record is [11-candidate-verification.md](11-candidate-verification.md).
