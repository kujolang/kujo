...
| V1TODO-020 | `src/jit.rs` | 4154 | TODO |                 // TODO: Implement proper tail-call optimization or save/restore slots | low | jit-owner | post-v1 | production | experimental JIT backlog outside default release-critical runtime path |
| V1TODO-021 | `src/jit.rs` | 8094 | TODO |     /// TODO: Integrate into VM execution loop for automatic profiling | low | jit-owner | post-v1 | production | experimental JIT backlog outside default release-critical runtime path |
| V1TODO-022 | `src/jit.rs` | 8111 | TODO |     /// TODO: Call from JIT-compiled code guard checks | low | jit-owner | post-v1 | production | experimental JIT backlog outside default release-critical runtime path |
| V1TODO-023 | `src/jit.rs` | 8120 | TODO |     /// TODO: Call from JIT-compiled code when guard checks fail | low | jit-owner | post-v1 | production | experimental JIT backlog outside default release-critical runtime path |
| V1TODO-024 | `src/jit.rs` | 8138 | TODO |     /// TODO: Use for adaptive recompilation decisions | low | jit-owner | post-v1 | production | experimental JIT backlog outside default release-critical runtime path |
| V1TODO-025 | `src/type_checker.rs` | 2886 | TODO |                 // TODO: Implement proper type checking for destructuring patterns | medium | typing-owner | post-v1 | production | optional typing/type-inference backlog outside runtime enforcement path |
| V1TODO-026 | `src/type_checker.rs` | 3371 | TODO |                 None // TODO: Return struct type when struct types are implemented | medium | typing-owner | post-v1 | production | optional typing/type-inference backlog outside runtime enforcement path |
| V1TODO-027 | `src/type_checker.rs` | 3377 | TODO |                 None // TODO: Look up field type from struct definition | medium | typing-owner | post-v1 | production | optional typing/type-inference backlog outside runtime enforcement path |
| V1TODO-028 | `src/type_checker.rs` | 3614 | TODO |                 // TODO: If we know it's a Promise<T>, return T | medium | typing-owner | post-v1 | production | optional typing/type-inference backlog outside runtime enforcement path |
| V1TODO-029 | `src/type_checker.rs` | 3725 | TODO |     /// TODO: This will be used when adding "Did you mean?" suggestions to interpreter | medium | typing-owner | post-v1 | production | optional typing/type-inference backlog outside runtime enforcement path |
