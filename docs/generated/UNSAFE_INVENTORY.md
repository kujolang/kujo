...
| src/interpreter/native_functions/filesystem.rs | 2340 | executable | src_executable_other |         assert_eq!(unsafe { libc::mkfifo(fifo_c.as_ptr(), 0o600) }, 0); |
| src/interpreter/native_functions/filesystem.rs | 2477 | executable | src_executable_other |         assert_eq!(unsafe { libc::mkfifo(fifo_name.as_ptr(), 0o600) }, 0); |
