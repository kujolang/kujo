...
| `list_dir_beneath` | `list_dir_beneath(root, relative_directory, after, suffix, limit, max_entries)` | exact 6 | dictionary | Confined no-follow traversal; bounded sorted UTF-8 names and exclusive cursor. Rejects excessive directory entries, invalid limits, and traversal. | `filesystem-read` | `page := list_dir_beneath("trusted", "records", "", ".json", 100, 100000)` |
