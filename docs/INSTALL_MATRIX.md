...
Status: stable v1.5.0 install matrix
...
| Install from npm | `npm install --global @kujolang/kujo-runtime@1.4.0` | `kujo` on `PATH` | Node.js 18+ environments that can use the previous runtime | The public npm channel remains at 1.4.0; use native archives for 1.5.0 APIs. |
