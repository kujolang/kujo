...
| VM fixture coverage | Ready for release review | `docs/generated/VM_RUNTIME_MISMATCH_INVENTORY.md` reports `P0 runtime-parity-bug: 0` and `vm_matches_snapshot: 145/145` |
