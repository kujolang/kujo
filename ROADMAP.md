...
> Current crate version: `1.2.2` in [Cargo.toml](Cargo.toml)
Target release: 1.0.0
Release state: Kujo `v1.2.2` is the current stable release. Launch verification and artifact evidence are preserved in `docs/V1_0_OFFICIAL_RELEASE_CHECKLIST.md` and `docs/RELEASE_ARTIFACT_CHECKLIST_V1_0_0.md`.
