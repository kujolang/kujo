...
Options:
  ...
  --target <name>          Fuzz target name (for example: lexer, parser, xml_bounded, gzip_bounded, zip_single_bounded, pdf_html_profile). If omitted, infer from .../artifacts/<target>/...
...
Examples:
  ...
  scripts/fuzz_repro.sh --target parser --artifact tests/fixtures/fuzz/synthetic_crash_input.kujo --dry-run
EOF
}
